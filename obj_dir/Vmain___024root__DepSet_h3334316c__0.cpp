...
VL_INLINE_OPT void Vmain___024root___nba_sequent__TOP__0(Vmain___024root* vlSelf) {
    ...
    if (vlSelf->main__DOT__DCFlush_EXFlush) {
        ...
        vlSelf->main__DOT__IFPC_DCPC = vlSelf->main__DOT__DCFlushAddr_EXFlushAddr;
        vlSelf->main__DOT__DCfunc3Out_EXfunc3 = 0U;
        vlSelf->main__DOT__DCrdOut_EXrd = 0U;
        vlSelf->main__DOT__DCopcodeOut_EXopcode = 0x33U;
    ...
    if (((((((0U != (IData)(vlSelf->main__DOT__DCrs1Out_RFrs1)) 
             | (0U != (IData)(vlSelf->main__DOT__DCrs2Out_RFrs2))) 
